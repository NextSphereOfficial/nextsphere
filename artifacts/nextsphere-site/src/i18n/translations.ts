...
export const translations = {
  en: {
    ...
    'legal.hub.subtitle': 'Access NextSphere company information and the official legal documents published in this area.',
    ...
    'legal.hub.documentsIntro': 'Access the official documents and download the corresponding PDF from each section.',
    'legal.hub.pdfPending': 'PDF coming soon',
    'legal.hub.pdfAvailable': 'PDF available',
    ...
    'legal.hub.documentReadyTitle': 'Official document',
    'legal.hub.documentReadyText': 'This is the official document provided for publication. Use the button below to download the original PDF.',
    'legal.hub.readDocumentTitle': 'Read the document',
    'legal.hub.readDocumentHint': 'The official document is reproduced above page by page, preserving its original content and layout. Scroll inside the viewer to read every page.',
    'legal.hub.pdfPageLabel': 'Page',
    ...
    'legal.hub.downloadReadyHint': 'The original PDF opens as a download and is not modified by the website.',
    ...
    'legal.documents.lumoTerms.title': 'Lumo Terms of Use',
  ...
  it: {
    ...
    'legal.hub.subtitle': 'Accedi ai riferimenti di NextSphere e ai documenti legali ufficiali pubblicati in questa area.',
    ...
    'legal.hub.documentsIntro': 'Consulta i documenti ufficiali e scarica il relativo PDF da ciascuna sezione.',
    'legal.hub.pdfPending': 'PDF in arrivo',
    'legal.hub.pdfAvailable': 'PDF disponibile',
    ...
    'legal.hub.documentReadyTitle': 'Documento ufficiale',
    'legal.hub.documentReadyText': 'Questo è il documento ufficiale fornito per la pubblicazione. Usa il pulsante qui sotto per scaricare il PDF originale.',
    'legal.hub.readDocumentTitle': 'Leggi il documento',
    'legal.hub.readDocumentHint': 'Il documento ufficiale è riprodotto qui sopra pagina per pagina, mantenendo contenuti e impaginazione originali. Scorri all’interno del visualizzatore per leggere tutte le pagine.',
    'legal.hub.pdfPageLabel': 'Pagina',
    ...
    'legal.hub.downloadReadyHint': 'Il PDF originale viene scaricato senza modifiche da parte del sito.',
    ...
    'legal.documents.lumoTerms.title': 'Termini di utilizzo Lumo',
