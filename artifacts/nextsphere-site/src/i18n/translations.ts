...
export const translations = {
  en: {
    ...
    // Hero
    'hero.badge': 'Lumo — the digital concierge for your property',
    'hero.title': 'Hours back. Guests delighted. Always.',
    'hero.subtitle': 'Lumo by NextSphere answers every question from your B&B, vacation rental or Airbnb guests — automatically, via QR code, in any language. No more midnight calls, no more repetitive messages.',
    ...
    'meta.airbnb.title': 'Digital Assistant for Airbnb Hosts | NextSphere — Lumo',
    'meta.airbnb.description': "Lumo automatically answers your Airbnb guests' questions via QR code. Zero repetitive messages, zero late-night calls. Try free for 14 days.",
    'meta.booking.title': 'Digital Assistant for Booking.com Hosts | NextSphere — Lumo',
    'meta.booking.description': "Lumo automatically handles your Booking.com guests' requests. Digital guide, QR code, answers in 30+ languages. Perfect for B&Bs and small hotels. Try free.",
    'meta.guideDigitale.title': 'Digital Guest Guide | Create Yours with NextSphere — Lumo',
    ...
    'pricing.page.includes.f1': 'Lumo AI assistant, fully customised for your property',
    ...
    'airbnb.hero.highlight': 'Lumo has all the answers.',
    'airbnb.hero.subtitle': 'Wi-Fi, check-in, house rules, parking, restaurants — Lumo answers 24/7 on your behalf. Guests scan a QR code and find exactly what they need instantly.',
    ...
    'airbnb.problem.caption': 'The same questions, every week, from every guest. With Lumo, you answer once — and it works forever.',
    'airbnb.how.title': 'How it works with Airbnb',
    'airbnb.how.step1.title': 'Set up Lumo in 10 minutes',
    'airbnb.how.step1.desc': 'Enter your property details: rules, Wi-Fi, check-in times, local recommendations. Lumo builds its knowledge base automatically.',
    ...
    'airbnb.benefits.title': 'Why Airbnb hosts choose Lumo',
    ...
    'airbnb.benefits.b2.desc': 'Instant answer = happy guest = better review. Lumo responds in 2 seconds, in any language.',
    'airbnb.benefits.b3.title': 'Zero ongoing management',
    'airbnb.benefits.b3.desc': 'Update your info once — check-in, Wi-Fi, rules — and Lumo uses it forever. No daily maintenance.',
    ...
    'airbnb.cta.subtitle': 'Set up Lumo in 10 minutes. 14-day free trial, no credit card.',

    // Booking page
    'booking.hero.badge': 'Built for Booking.com hosts',
    'booking.hero.title': 'Your Booking.com guests deserve instant answers.',
    'booking.hero.highlight': 'Lumo delivers them — always.',
    'booking.hero.subtitle': 'B&Bs, apartments and small hotels on Booking.com share a common challenge: international guests arriving with countless questions. Lumo answers in 30+ languages, 24/7, with no effort from you.',
    ...
    'booking.problem.caption': 'Every international guest brings new questions. Lumo answers them all — automatically, in their language.',
    'booking.how.title': 'Lumo in your Booking.com property',
    'booking.how.step1.title': 'A tailored digital guide',
    'booking.how.step1.desc': 'Set up Lumo with all your property information: hours, rules, services, local tips — in Italian, English, and any other language your guests speak.',
    ...
    'booking.how.step3.desc': 'Lumo answers 24/7. You focus on hospitality and what actually matters. Repetitive questions disappear.',
    'booking.benefits.title': 'Built for B&Bs, guesthouses and small hotels',
    'booking.benefits.b1.title': 'Natively multilingual',
    'booking.benefits.b1.desc': 'German, French, Japanese guests — Lumo detects the language and replies fluently. No language barriers.',
    'booking.benefits.b2.title': 'Your property, always "open"',
    'booking.benefits.b2.desc': "Check-in at 2am? Parking question on Sunday morning? Lumo is always there, even when you can't respond.",
    ...
    'booking.benefits.b4.desc': 'Informed, independent guests leave more positive reviews. Lumo improves the experience without any extra effort from you.',
    'booking.cta.title': 'Your Booking.com property deserves a digital assistant.',
    'booking.cta.subtitle': 'Set up Lumo in 10 minutes. 14-day free trial, no credit card.',
    ...
    'guideDigitale.hero.subtitle': "Instead of a laminated sheet nobody reads, your guests get Lumo: an interactive digital guide for short-term rentals, always up to date, accessible with a QR code. It answers their questions like a concierge — without you needing to be there.",
    ...
    'guideDigitale.what.p2': "With Lumo, the guide isn't just browsable — it's conversational. The guest asks a question in natural language and gets a precise answer, in their language, within seconds.",
    ...
    'guideDigitale.vs.digital': 'Lumo digital guide',
  ...
  it: {
    ...
    // Hero
    'hero.badge': 'Lumo — il concierge digitale per la tua struttura',
    'hero.title': 'Ore risparmiate. Ospiti felici. Sempre.',
    'hero.subtitle': 'Lumo di NextSphere risponde automaticamente a ogni domanda degli ospiti del tuo B&B, affitto breve o Airbnb — via QR code, in qualsiasi lingua, 24/7. Niente più messaggi ripetitivi.',
    ...
    'meta.airbnb.title': 'Assistente Digitale per Host Airbnb | NextSphere — Lumo',
    'meta.airbnb.description': 'Lumo risponde automaticamente alle domande dei tuoi ospiti Airbnb tramite QR code. Zero messaggi ripetitivi, zero chiamate notturne. Prova gratis 14 giorni.',
    'meta.booking.title': 'Assistente Digitale per Host Booking.com | NextSphere — Lumo',
    'meta.booking.description': 'Lumo gestisce automaticamente le richieste degli ospiti Booking.com. Guida digitale, QR code, risposte in 30+ lingue. Ideale per B&B e piccoli hotel. Prova gratis.',
    'meta.guideDigitale.title': 'Guida Digitale per Ospiti | Crea la Tua con NextSphere — Lumo',
    ...
    'pricing.page.includes.f1': 'Assistente AI Lumo personalizzato sulla tua struttura',
    ...
    'airbnb.hero.highlight': 'Lumo ha tutte le risposte.',
    'airbnb.hero.subtitle': 'Wi-Fi, check-in, regole della casa, parcheggio, ristoranti — Lumo risponde 24/7 al posto tuo. Gli ospiti scansionano il QR code e trovano subito tutto quello che cercano.',
    ...
    'airbnb.problem.caption': 'Le stesse domande, ogni settimana, da ogni ospite. Con Lumo, rispondi una volta sola — e funziona per sempre.',
    'airbnb.how.title': 'Come funziona con Airbnb',
    'airbnb.how.step1.title': 'Configuri Lumo in 10 minuti',
    'airbnb.how.step1.desc': 'Inserisci i dati della tua struttura: regole, Wi-Fi, check-in, raccomandazioni locali. Lumo costruisce la sua base di conoscenza automaticamente.',
    ...
    'airbnb.benefits.title': 'Perché gli host Airbnb scelgono Lumo',
    ...
    'airbnb.benefits.b2.desc': 'Risposta immediata = ospite felice = recensione migliore. Lumo risponde in 2 secondi, in qualsiasi lingua.',
    'airbnb.benefits.b3.title': 'Zero gestione quotidiana',
    'airbnb.benefits.b3.desc': 'Aggiorni le informazioni una volta — check-in, Wi-Fi, regole — e Lumo le usa sempre. Nessuna manutenzione quotidiana.',
    ...
    'airbnb.cta.subtitle': 'Configura Lumo in 10 minuti. 14 giorni gratis, nessuna carta di credito.',

    // Pagina Booking
    'booking.hero.badge': 'Pensato per host Booking.com',
    'booking.hero.title': 'I tuoi ospiti Booking meritano risposte immediate.',
    'booking.hero.highlight': 'Lumo le dà — sempre.',
    'booking.hero.subtitle': 'B&B, appartamenti e piccoli hotel su Booking.com hanno una sfida comune: ospiti internazionali con mille domande diverse. Lumo risponde in 30+ lingue, 24/7, senza che tu debba fare nulla.',
    ...
    'booking.problem.caption': 'Ogni ospite internazionale porta nuove domande. Lumo le risponde tutte — automaticamente, nella loro lingua.',
    'booking.how.title': 'Lumo nella tua struttura Booking.com',
    'booking.how.step1.title': 'Una guida digitale su misura',
    'booking.how.step1.desc': 'Configuri Lumo con tutte le informazioni della tua struttura: orari, regole, servizi, consigli locali. In italiano, inglese, e in qualsiasi lingua parlino i tuoi ospiti.',
    ...
    'booking.how.step3.desc': 'Lumo risponde 24/7. Tu ti concentri sull\'accoglienza e su quello che conta davvero. Le domande ripetitive spariscono.',
    'booking.benefits.title': 'Adatto a B&B, affittacamere e piccoli hotel',
    'booking.benefits.b1.title': 'Multilingue nativo',
    'booking.benefits.b1.desc': 'Ospiti tedeschi, francesi, giapponesi — Lumo rileva la lingua e risponde fluentemente. Nessuna barriera linguistica.',
    'booking.benefits.b2.title': 'La tua struttura sempre "aperta"',
    'booking.benefits.b2.desc': 'Check-in alle 2 di notte? Domanda sul parcheggio domenica mattina? Lumo c\'è sempre, anche quando tu non puoi rispondere.',
    ...
    'booking.benefits.b4.desc': 'Ospiti informati e autonomi lasciano recensioni più positive. Lumo migliora l\'esperienza senza che tu debba fare nulla di extra.',
    'booking.cta.title': 'La tua struttura Booking merita un assistente digitale.',
    'booking.cta.subtitle': 'Configura Lumo in 10 minuti. 14 giorni gratis, nessuna carta di credito.',
    ...
    'guideDigitale.hero.subtitle': 'Invece di un foglio plastificato che nessuno legge, i tuoi ospiti hanno Lumo: una guida digitale interattiva per affitti brevi, sempre aggiornata, accessibile con un QR code. Risponde alle loro domande come un concierge — senza che tu debba essere presente.',
    ...
    'guideDigitale.what.p2': 'Con Lumo la guida non è solo consultabile — è conversazionale. L\'ospite fa una domanda in linguaggio naturale e riceve la risposta precisa, nella sua lingua, in pochi secondi.',
    ...
    'guideDigitale.vs.digital': 'Guida digitale Lumo',
