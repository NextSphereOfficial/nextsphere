export const translations = {
  en: {
    ...
    'legal.privacy.lastUpdated': 'Last updated: October 2023',
    ...
    'legal.privacy.h2.text': 'When you use our contact form, we collect your name, email address, property type, and the content of your message. If you accept our cookie banner, we may also collect anonymized usage analytics.',
    'legal.privacy.h3': '3. Purpose of Processing',
    'legal.privacy.h3.text': 'We use your data to respond to your inquiries, provide support, and improve our services. We do not sell your data to third parties.',
    'legal.privacy.h4': '4. Data Retention',
    'legal.privacy.h4.text': 'Contact form data is retained for a maximum of 2 years to ensure quality of service and follow-up capability.',
    'legal.privacy.h5': '5. Your Rights',
    'legal.privacy.h5.text': 'Under GDPR (Articles 15-20), you have the right to access, rectify, erase, or port your data. You may also withdraw your consent at any time. To exercise these rights, please contact privacy@nextsphere.it.',
  ...
  it: {
    ...
    // Legal Pages
    'legal.privacy.title': 'Privacy Policy',
    'legal.privacy.lastUpdated': 'Ultimo aggiornamento: Ottobre 2023',
    ...
    'legal.privacy.h2.text': 'Quando utilizzi il nostro modulo di contatto, raccogliamo il tuo nome, indirizzo email, tipo di struttura e il contenuto del tuo messaggio. Se accetti il nostro banner sui cookie, potremmo raccogliere anche dati analitici anonimi.',
    'legal.privacy.h3': '3. Finalità del Trattamento',
    'legal.privacy.h3.text': 'Utilizziamo i tuoi dati per rispondere alle tue richieste, fornire supporto e migliorare i nostri servizi. Non vendiamo i tuoi dati a terze parti.',
    'legal.privacy.h4': '4. Conservazione dei Dati',
    'legal.privacy.h4.text': 'I dati del modulo di contatto vengono conservati per un massimo di 2 anni per garantire la qualità del servizio.',
    'legal.privacy.h5': '5. I Tuoi Diritti',
    'legal.privacy.h5.text': 'Ai sensi del GDPR (Art. 15-20), hai il diritto di accedere, rettificare, cancellare o trasferire i tuoi dati. Puoi anche revocare il consenso in qualsiasi momento. Per esercitare questi diritti, contatta privacy@nextsphere.it.',
