...
import { ShieldCheck, ScanLine, Clock, MessageSquareOff, Globe2, Zap } from 'lucide-react';
...
export default function Airbnb() {
  ...
  const steps = [
    { icon: ShieldCheck, title: t('airbnb.how.step1.title'), desc: t('airbnb.how.step1.desc') },
    { icon: ScanLine,    title: t('airbnb.how.step2.title'), desc: t('airbnb.how.step2.desc') },
    { icon: Clock,       title: t('airbnb.how.step3.title'), desc: t('airbnb.how.step3.desc') },
  ];

  const benefits = [
    { icon: MessageSquareOff, title: t('airbnb.benefits.b1.title'), desc: t('airbnb.benefits.b1.desc') },
    { icon: Globe2,           title: t('airbnb.benefits.b2.title'), desc: t('airbnb.benefits.b2.desc') },
    { icon: Zap,              title: t('airbnb.benefits.b3.title'), desc: t('airbnb.benefits.b3.desc') },
    { icon: ScanLine,         title: t('airbnb.benefits.b4.title'), desc: t('airbnb.benefits.b4.desc') },
  ];

  const problems = [1, 2, 3, 4].map((i) => t(`airbnb.problem.item${i}` as any));
  ...
  return (
    <div className="w-full">
      ...
      <section className="relative bg-[#0D0D0D] pt-36 pb-28 overflow-hidden">
        <div
          className="absolute top-1/3 right-1/4 w-[600px] h-[500px] rounded-full blur-[130px] pointer-events-none"
          style={{ background: 'radial-gradient(circle, rgba(222,182,125,0.2) 0%, transparent 70%)' }}
        />
        <motion.div
          className="absolute bottom-0 left-1/4 w-[500px] h-[350px] rounded-full blur-[100px] pointer-events-none"
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          <motion.div initial="hidden" animate="visible" variants={fadeUp}>
            ...
            <p className="text-3xl md:text-5xl font-bold text-primary mb-8 leading-tight">
              {t('airbnb.hero.highlight')}
            </p>
            <p className="text-lg text-gray-400 max-w-2xl mx-auto mb-10 leading-relaxed">
              {t('airbnb.hero.subtitle')}
            </p>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-4xl mx-auto px-6">
          ...
          >
            {problems.map((text, i) => (
              <motion.div
                key={i}
                variants={fadeUp}
                className="bg-gray-50 border border-gray-200 rounded-2xl p-6 text-gray-700 text-lg font-medium italic"
              >
                {text}
              </motion.div>
            ))}
          ...
          >
            {t('airbnb.problem.caption')}
          </motion.p>
        </div>
      </section>

      {/* ── HOW IT WORKS ── */}
      <section id="how-airbnb" className="py-24 bg-gray-50 border-y border-gray-200">
      ...
      <section className="py-24 bg-[#0D0D0D] text-white relative overflow-hidden">
        ...
        <div className="max-w-2xl mx-auto px-6 text-center relative z-10">
          <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
            <h2 className="text-4xl md:text-5xl font-bold mb-4">{t('airbnb.cta.title')}</h2>
            <p className="text-gray-400 text-lg mb-10">{t('airbnb.cta.subtitle')}</p>
            <a
              href="#"
